...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("is_active", sa.Boolean(), nullable=False, server_default=sa.text("true")),
        sa.Column("show_kit_section", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("show_tail_section", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("show_material_description", sa.Boolean(), nullable=False, server_default=sa.text("true")),
        sa.Column("show_thermo_visit", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.Column("updated_by_user_id", sa.Integer(), sa.ForeignKey("users.id"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("blank_type_de", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("blank_type_se", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("photo_1", sa.String(length=300), nullable=True),
        ...
        sa.Column("author_external", sa.Boolean(), nullable=False, server_default=sa.text("false")),
