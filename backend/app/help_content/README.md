...
- Первый `# Заголовок` в page-help можно оставлять в markdown: при рендере модалки он снимается (title уже в шапке модалки). В FAQ ведущий H1 сохраняется.
- Старший админ видит материалы с `roles: [admin]` (как наследование прав в приложении).
