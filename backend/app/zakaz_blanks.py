...
_BLANKS: tuple[ZakazBlankDef, ...] = (
    ...
    ZakazBlankDef("SE_BRAID_FREE_TIP", "S.E. ажурная коса", "SE", 150.0, 11.0, True),
    ...
    ZakazBlankDef("DE_CURL", "D.E. термокудря", "DE", 200.0, 25.0, True),
    ZakazBlankDef("DE_DREAD_FREE_TIP", "D.E. дредокудря", "DE", 90.0, 35.0, True),
